	...
	<div class="container">
		...
		<form class="div_form" action="/admin/list-author" method="post">
			...
			<div style="text-align: center;">
				<button style="margin: 0 10px 50px" formaction="/Website_QuaTrinh/admin/edit-author/insert"
					class="btn btn-outline-success">Insert</button>
				<button style="margin: 0 10px 50px" formaction="/Website_QuaTrinh/admin/edit-author/update?authorID=${author.authorID}"
					class="btn btn-outline-warning">Update</button>
				<button style="margin: 0 10px 50px" formaction="/Website_QuaTrinh/admin/edit-author/delete?authorID=${author.authorID}"
					class="btn btn-outline-danger">Delete</button>
				<button style="margin: 0 10px 50px" formaction="/Website_QuaTrinh/admin/edit-author/reset"
				...
				<c:forEach var="author" items="${authors}">
					<tr>
						...
						<td><a style="text-decoration: none"
							href="/Website_QuaTrinh/admin/edit-author/edit?authorID=${author.authorID}">Edit</a> || 
							<a style="text-decoration: none" class="delete"
							href="/Website_QuaTrinh/admin/edit-author/delete?authorID=${author.authorID}"> Delete</a>
						</td>
					</tr>
				</c:forEach>
