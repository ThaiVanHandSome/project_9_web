        ...
        <table border="1" style="width:500px">
            <tr>
                <td>
                    ...
                    <form class="div_form" action="/Website_QuaTrinh_21110559_NgoQuangNghia_01/login" method="post">
                        ...
                        <div style="text-align: center;">
                            <button style="margin-bottom: 50px"formaction="/Website_QuaTrinh_21110559_NgoQuangNghia_01/login" class="btn btn-success">Đăng nhập</button>
                        </div>
                    </form>
                    <p class="w-100 text-center">
                            &mdash; Bạn chưa có tài khoản ? &mdash; <a href="/Website_QuaTrinh_21110559_NgoQuangNghia_01/register"
