		...
		<form class="div_form" action="/admin/list-book" method="post">
			...
			<div style="text-align: center;">
				<button style="margin: 0 10px 50px"
					formaction="/Website_QuaTrinh_21110559_NgoQuangNghia_02/admin/edit-book/insert"
					class="btn btn-outline-success">Insert</button>
				<button style="margin: 0 10px 50px"
					formaction="/Website_QuaTrinh_21110559_NgoQuangNghia_02/admin/edit-book/update?id=${user.id}"
					class="btn btn-outline-warning">Update</button>
				<button style="margin: 0 10px 50px"
					formaction="/Website_QuaTrinh_21110559_NgoQuangNghia_02/admin/edit-book/delete?id=${user.id}"
					class="btn btn-outline-danger">Delete</button>
				<button style="margin: 0 10px 50px"
					formaction="/Website_QuaTrinh_21110559_NgoQuangNghia_02/admin/edit-book/reset"
				...
				<c:forEach var="book" items="${books}">
					<tr>
						...
						<td><a style="text-decoration: none"
							href="/Website_QuaTrinh_21110559_NgoQuangNghia_02/admin/edit-book/edit?bookid=${book.bookid}">Edit</a>
							|| <a style="text-decoration: none" class="delete"
							href="/Website_QuaTrinh_21110559_NgoQuangNghia_02/admin/edit-book/delete?bookid=${book.bookid}">
								Delete</a></td>
					</tr>
				</c:forEach>
