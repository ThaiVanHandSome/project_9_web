		...
		<form class="div_form" action="/admin/list-user" method="post">
			...
			<div style="text-align: center;">
				<button style="margin: 0 10px 50px"
					formaction="/Website_QuaTrinh_21110559_NgoQuangNghia_03/admin/edit-user/insert"
					class="btn btn-outline-success">Insert</button>
				<button style="margin: 0 10px 50px"
					formaction="/Website_QuaTrinh_21110559_NgoQuangNghia_03/admin/edit-user/update?id=${user.id}"
					class="btn btn-outline-warning">Update</button>
				<button style="margin: 0 10px 50px"
					formaction="/Website_QuaTrinh_21110559_NgoQuangNghia_03/admin/edit-user/delete?id=${user.id}"
					class="btn btn-outline-danger">Delete</button>
				<button style="margin: 0 10px 50px"
					formaction="/Website_QuaTrinh_21110559_NgoQuangNghia_03/admin/edit-user/reset"
				...
				<c:forEach var="user" items="${users}">
					<tr>
						...
						<td><a style="text-decoration: none"
							href="/Website_QuaTrinh_21110559_NgoQuangNghia_03/admin/edit-user/edit?id=${user.id}">Edit</a>
							|| <a style="text-decoration: none" class="delete"
							href="/Website_QuaTrinh_21110559_NgoQuangNghia_03/admin/edit-user/delete?id=${user.id}">
								Delete</a></td>
					</tr>
				</c:forEach>
