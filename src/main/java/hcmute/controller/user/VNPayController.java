...
import hcmute.model.PayRestModel;
...
public class VNPayController {
	...
	public String createPayment(@RequestParam("cost") Long cost, @RequestParam("data") String data) throws UnsupportedEncodingException {
		...
		urlReturn = urlReturn + "?data=" + encodeData(data);
		...
		PayRestModel payRestModel = new PayRestModel();
		payRestModel.setStatus("Ok");
		payRestModel.setMessage("Sussessfully");
		payRestModel.setURL(paymentUrl);
